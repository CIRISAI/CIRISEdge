...
- **`bootstrap`** = exactly `{Key, IdentityOccurrence, TransportDestination}`
  ...
  those three over all 19 kinds (§5.4; `EnvelopeKind::ALL` is 19 since
  `FamilyMembershipWidening` and `CommunityMembershipListing` in v32.0.0 — persist
  v49.0.0 #910/#912: the family widening twin and CC 2's `listed` plane, both riding
  the membership planes' projection; 17 since `CommunityMembershipWidening` in
  v31.0.0 — persist v48.0.0 #860; 16 since `KeyGrant` in v24.1.0).
