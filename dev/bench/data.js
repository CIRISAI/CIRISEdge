    ...
    "ciris-edge transport / A-V-mesh / replication benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8dcbf1698c5f2a175f8a57be8572fd26085f487d",
          "message": "feat(v15.13.0): adopt persist v25.1.0 + verify v12.0.0 lockstep (#447) + close #445\n\nThe second lockstep freight (CIRISEdge#447): persist v25.0.0→v25.1.0\n(54dd190) + all three verify crates v11.0.0→v12.0.0 in one commit (the\nfork rule). Source deltas absorbed:\n\n- CAPACITY_CONSENT_SCOPE → ANALYZE_CONSENT_SCOPE (the #569/CC 3.4.5\n  narrowing: consent-before-scoring binds the family that judges agents\n  — capacity:* stays gated, which is the only family edge emits;\n  delivered.rs's B5 gate is unchanged in behavior).\n- Revocation gains signed `revoked_after` (fixtures updated; §5's note\n  stands: enforcement is at the consumer's read — a follow-up candidate\n  for edge's revocation consumers, not silently absorbed).\n- #445: verify v11.1.0 re-cut the §19.7 v3 vector (authored n_eff=3 vs\n  derived 2). Edge's producer always DERIVED (balanced-mass case was\n  correct by construction); NEW test reproduces the re-cut unbalanced\n  masses and pins n_eff=2 so the retracted value can't return.\n\nDeliberately NOT absorbed yet (per #447's own holds): the byte-metered\nquota's typed RateLimited handling (follow-up — edge replication can now\nhit a ceiling it never hit; blind retry is wrong), quarantine serve\nconsult (persist-side), #589/#590/#587 (held upstream).\n\nGates: superset clippy -D warnings; lib 778/844/780\n(default/reticulum/test-anchor); conformance_vectors_v19_7 10/10;\nfield_conformance vs the v15.13.0 restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-02T22:12:59-05:00",
          "tree_id": "cfe17671e7d255768365d25576890f114e806c35",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/8dcbf1698c5f2a175f8a57be8572fd26085f487d"
        },
        "date": 1785732984689,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a4ee4871141a3a67b51e07e3009009dc3ee35e65",
          "message": "feat(v15.14.0): adopt persist v26.0.0 + verify v12.1.0 lockstep — source-clean\n\nThe third lockstep freight: persist v25.1.0→v26.0.0 (4b7e59f) + all\nthree verify crates v12.0.0→v12.1.0, one commit (the fork rule).\n\nv26's majors are runtime admission gates edge was already on the right\nside of: #589 (a promotion now faces the full tier-4 stack — the\npromote-bypass the #565 arc named as \"the PROMOTE path's pre-existing\nshape\", closed; capacity:* can never reach the local tier), #590\n(CC 3.1.7 R2 — a rowless family stops admitting; edge's emitted\nfamilies all carry registry rows, proven by the suites running through\npersist's real gates), #591 (escalation on steward silence). Zero edge\nsource changes beyond the pins.\n\nGates: superset clippy -D warnings; lib 778/844/780 (default/reticulum/\ntest-anchor); conformance vectors 10/10; genesis bootstrap 6/6;\nfield_conformance vs the v15.14.0 restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-03T08:45:16-05:00",
          "tree_id": "ca200b49780805e8ea3af2ac08da1ac38311c16f",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/a4ee4871141a3a67b51e07e3009009dc3ee35e65"
        },
        "date": 1785771127239,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1b503a49926ba0321c865f51cdfd724127f27973",
          "message": "feat(v15.15.0): adopt persist v28.1.0 + verify v12.5.0 lockstep — ahead of the v28.2 manageable-mesh cut\n\nSkips through v27.0.0 + v28.0.0 (#448/#449) to v28.1.0 in one lockstep\nflip (persist v26.0.0→v28.1.0, verify v12.1.0→v12.5.0 — persist's own\npin, matched). Source-clean; all four freights are read-time refusal\ntightenings edge is on the right side of:\n\n- #448/v27: steward-binding liveness (a delegation dies once ANY\n  admitted withdraws/recants names it). Edge's SelfOnly widening keys on\n  owner_of, which already shared the fixed walk (#578); an empty self\n  boundary is fail-secure, not an error.\n- #449/v28: the same fold for moderation authority. Checked: edge has\n  ZERO is_*_json truthy misuse (Rust-typed calls only; the misuse class\n  is Python-caller-side).\n- v28.1: #564 stage 2 (host reachability + may_release_copy) —\n  persist-internal, no edge ask.\n\nPositions edge one flip from the v28.2 manageable-mesh cut.\n\nGates: superset clippy -D warnings; lib 778/844/780; conformance\nvectors 10/10; genesis bootstrap 6/6; field_conformance vs restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-03T15:03:19-05:00",
          "tree_id": "f97e80ca843c7ab5bc0487dc1e88c4d0dd3cb46a",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/1b503a49926ba0321c865f51cdfd724127f27973"
        },
        "date": 1785793932119,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d4b325ed8a36432085b2a9aea56a78fd0f56762b",
          "message": "feat(v15.17.0): adopt persist v29.0.0 + verify v13.0.0 lockstep (through v28.3.0) — source-clean\n\nThe MAJOR lockstep (CIRISEdge#452): persist v28.2.0→v29.0.0 (through\nthe unadopted v28.3.0/#451) + all three verify crates v12.5.0→v13.0.0\nin one commit — the fork rule, persist's own seven-pins-one-commit\ndiscipline mirrored.\n\nEdge checks from both adoption notes, all clean:\n- #452 §2 Gating::Normative/Structural split + ClassificationStanding's\n  new variant: edge references NEITHER type — no source break.\n- #451 §1 media-plane emitter gates removed (content_rating:/\n  content_class:/cw_class: admit from any emitter per CC 3.3.12 open\n  vocabulary + CC 3.4.14 R1 / EU AI Act Art. 50(2)): edge never\n  inspects media-plane dimensions and draws no trusted-emitter\n  inference from admission — byte-transport only.\n- #452 §3 mesh_config durability reversal (cold durable admits under\n  quorum, refused at threshold-1): the plane is persist-side state;\n  edge's #440 consumption work remains open and now has its substrate.\n\nGates: superset clippy -D warnings; lib 778/844/780; conformance\nvectors 10/10; genesis bootstrap 6/6; field_conformance vs restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-03T21:41:00-05:00",
          "tree_id": "048c0b5856f33660965e2d28eb9e061e9d001b23",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/d4b325ed8a36432085b2a9aea56a78fd0f56762b"
        },
        "date": 1785817484816,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6a42dcf1da3dc15a8cb8f65b53c1c9d2ccec730c",
          "message": "feat(v15.18.0): adopt persist v30.0.0 + publish the fountain-floor manifest (#453) — transcription structurally closed\n\npersist v29.0.0→v30.0.0 (b08dbbc; verify stays v13.0.0, persist's own\npin). Source-clean adopt — v30's typed-axes split (Symbols vs Holders)\nis the registry-side fix for CIRISPersist#602's two transcription\ndefects (k_repair_target carrying n_source's 20; an UNSATISFIABLE\nmin_viable_floor ceiling of 3 under edge's floor of 5).\n\nThe #453 ask — close the half only edge can close: the five planner\nconstants now emit as a machine-readable manifest\n(fountain_floor_manifest() → evidence/CIRISEdge.fountain_floors.json)\npersist vendors and gates ceilings against, replacing its hand-kept\nCONSUMER_FLOORS table. The vendored artifact is byte-locked to the live\nconstants by the fountain_floors_json_matches_emitted drift test —\ntranscription impossible in either direction (the #442/evidence-TSV\npattern applied to config floors). schema_version versions the SHAPE\nonly; value provenance is the vendored git tag, so the artifact does\nnot churn on floor-neutral edge releases. The K=6 knee travels with it\n(manifest_k_repair_is_the_pinned_knee, backed by\nrepair_headroom_knee_at_k_6's property test).\n\nGates: superset clippy -D warnings; lib 780/846/782; field_conformance\nvs the v15.18.0 restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-05T14:04:01-05:00",
          "tree_id": "18078d4031a6f2935952ea35988f321810df8741",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/6a42dcf1da3dc15a8cb8f65b53c1c9d2ccec730c"
        },
        "date": 1785963056363,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "82cd942bebf71c268703da89717d2ba77c7592be",
          "message": "fix(v15.18.1): adopt persist v30.0.1 — source-clean patch re-pin\n\nGates: superset clippy -D warnings; lib 780/846/782; field_conformance\nvs restamp.\n\nCo-Authored-By: Claude Opus 4.8 <noreply@anthropic.com>\nClaude-Session: https://claude.ai/code/session_012MqRfBEZ3CHfbMt6E2yw48",
          "timestamp": "2026-08-05T18:02:47-05:00",
          "tree_id": "2b8abb5737ee8441fe44e51bff65a8254baa3e64",
          "url": "https://github.com/CIRISAI/CIRISEdge/commit/82cd942bebf71c268703da89717d2ba77c7592be"
        },
        "date": 1785977043187,
        "tool": "cargo",
        "benches": [
